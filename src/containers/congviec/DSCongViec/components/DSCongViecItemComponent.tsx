        ...
        <View style={styles.itemView} >
            <TouchComponent style={styles.infoView} onPress={_onItemPress}>
                ...
                <View style={styles.nameView}>
                    <CardName>
                        <Text style={styles.name}>{props?.item?.bookNumber}{props?.item?.symbol}</Text>
                    </CardName>
                </View>
                <View style={styles.viewDate}>
                    <View style={styles.viewinDate}>
                        <Text style={styles.viewDateLabel}>Thời hạn bảo quản: </Text>
                        <Text style={styles.viewDateContent}>{props?.item?.expiryDateName}</Text>
                    </View>
