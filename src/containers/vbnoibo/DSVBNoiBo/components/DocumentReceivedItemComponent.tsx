...
import { TimeWaitIcon, FileIcon } from '@images/index'
import { scale, verticalScale, moderateScale, moderateVerticalScale } from 'react-native-size-matters';
import { TouchComponent, Divide, CardName, DSFilesModalComponent } from '@components/index'
...
const DocumentReceivedItemComponent = (props: Props) => {
...
DocumentReceivedItemComponent.defaultProps = {

};

export default memo(DocumentReceivedItemComponent);
