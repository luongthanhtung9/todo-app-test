...
const HeaderTabComponent = (props: Props) => {
    const { title, listDayofWeek, currentNumberWeek, currentMonth, leadUserName, onChangeLD, onWeekNow } = props
                ...
                <View style={styles.viewNgayThu}>
                    {
                        props.listDayofWeek?.map((item, index) => {
                            return <TouchComponent key={index} style={{ width: '14%', alignContent: 'center', alignItems: 'center' }}>
