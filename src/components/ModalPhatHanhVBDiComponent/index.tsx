...
const ModalPhatHanhVBDiComponent = (props: Props) => {
			...
			<Modal
				...
				<View style={styles.container}>
					<View style={styles.viewTitle}>
						<Text style={styles.textTitle}>Cấp phát hành</Text>
...
ModalPhatHanhVBDiComponent.defaultProps = {
	isVisible: false,
};
...
export default connect(mapStateToProps)(memo(ModalPhatHanhVBDiComponent));
