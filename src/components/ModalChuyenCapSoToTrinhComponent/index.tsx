...
const ModalChuyenCapSoToTrinhComponent = (props: Props) => {
...
ModalChuyenCapSoToTrinhComponent.defaultProps = {
	isVisible: false,
};
...
export default connect(mapStateToProps)(memo(ModalChuyenCapSoToTrinhComponent));
