...
const ModalChuyenCapSoComponent = (props: Props) => {
...
ModalChuyenCapSoComponent.defaultProps = {
  isVisible: false,
};
...
export default connect(mapStateToProps)(memo(ModalChuyenCapSoComponent));
